...
- **Legacy banking portals (NIBSS, old CBN tools):** table-heavy grids, grey-on-grey hierarchy, 2008 enterprise density, no breathing room. PayOps must feel like a deliberate step forward from this — not a clone of what Nigerian operators already mistrust.
